...
/// <summary>EF Core entity — one row per calendar event stored in SQLite.</summary>
public class CalendarEvent
{
    ...
    /// <summary>Hex colour used to tint the event chip, e.g. "#0078D4".</summary>
    ...
    /// <summary>
    /// Single-line tooltip shown on calendar chips: title + time (or date range for
    /// multi-day events), plus location if set.
    /// </summary>
    public string ChipTooltip
    {
        get
        {
            var timeStr = IsMultiDay
